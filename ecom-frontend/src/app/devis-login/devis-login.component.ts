...
@Component({
  selector: 'app-devis-login',
  templateUrl: './devis-login.component.html',
  styleUrls: ['./devis-login.component.css']
  
})
export class DevisLoginComponent implements OnInit {
  isNewProduct = true;
  profiles: Profile[];
  blogForm: FormGroup;
  ...
  addBlog(blogForm: NgForm){
    ...
    this.blogService.addReservationLogin(blogFormData).subscribe(
