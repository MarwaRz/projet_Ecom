...
@Component({
  selector: 'app-reservation-employe',
  templateUrl: './reservation-employe.component.html',
  styleUrls: ['./reservation-employe.component.css']
})
export class ReservationEmployeComponent implements OnInit {
userName:String;
  ...
  updateProfile(reservationId:any){
    this.router.navigate(['/actualizar_reservas',  reservationId]);
  }
